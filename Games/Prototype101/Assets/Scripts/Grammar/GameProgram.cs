...
public class GameProgram
{
    ...
    //static private PlatformerProgram _pProgram;
    //static private DungeonProgram _dProgram;
        ...
        public IEnumerator Execute() //What it should do when this command gets executed
        {
            ...
            switch (_num) {
                ...
                default:
                    ...
                    Debug.Log("player gen: # player positions: " + _playerPositions.Count);
